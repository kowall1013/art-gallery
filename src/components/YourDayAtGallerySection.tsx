  ...
  return (
    <Wrapper>
      ...
      <ContentWrapper>
        ...
        <Description>Wander through our distinct collections and find new insights about our artists. Dive into the details of their creative process.</Description>
      </ContentWrapper>
      <ImageWarppar>
      ...
      <ContentInspiredWrapper>
        ...
        <Description>We’re excited to welcome you to our gallery and see how our collections influence you.</Description>
      </ContentInspiredWrapper>
  </Wrapper>
  )
}
